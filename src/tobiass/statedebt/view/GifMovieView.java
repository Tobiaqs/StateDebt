...
public class GifMovieView extends View {
	...
	private void setViewAttributes(Context context, AttributeSet attrs, int defStyle) {
		...
		final TypedArray standardAttributeArray = context.obtainStyledAttributes(attrs, new int[] {android.R.attr.alpha}, defStyle, R.style.Widget_GifMoviewView);
		
		mAlpha = standardAttributeArray.getFloat(0, 1);
		mPaint = new Paint();
